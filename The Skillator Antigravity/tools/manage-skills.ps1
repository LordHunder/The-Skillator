...
if ($GlobalGemini) {
    ...
    # Default to current workspace directory's agent skills
    $ActiveSkillsDir = Join-Path (Get-Location) ".agent\skills"
}
...
if ($Install) {
    ...
    # Adapt to Gemini / Codex / Antigravity by rewriting Claude-specific terms in SKILL.md
...
Write-Host "Cybersecurity Skill Manager" -ForegroundColor White
