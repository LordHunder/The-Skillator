...
if ($GlobalClaude) {
    ...
    $ActiveSkillsDir = Join-Path $ProjectRoot ".claude\skills"
}
...
if ($Install) {
    ...
    Write-Host ("[OK] Skill '" + $targetSkill.Name + "' installed natively for Claude Code!") -ForegroundColor Green
...
# Default Help
Write-Host "================================================================================" -ForegroundColor Cyan
Write-Host "The Skillator -- Universal Multi-Repo Skill Manager (Claude Code Edition)" -ForegroundColor White
Write-Host "================================================================================" -ForegroundColor Cyan
...
Write-Host "  .\manage-skills.ps1 -Install <skill-name>      # Install a specific skill natively" -ForegroundColor Gray
